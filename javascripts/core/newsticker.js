...
["The cookie is a lie.", true, "a1"], ["Matter cookies have been confirmed to not exist, whoever claims that, stop.", true, "a4"], ["Matter ghosts do not exist. Just like matter ghosts. They don't have any matter, for that matter.", true, "a2"],
["Nuclear power plants have been abandoned in favor of Matter power.", true, "a3"],
["Matter prices have drastically dropped due to newfound abundance.", true, "a5"], ["In the news today, humans make an Matter animal sacrifice to the Matter god.", true, "a6"], ["You made one Matter! Whatever that means.", true, "a7"],
["Scientists confirm that the colour of Matter is Blurple", true, "a11"], ["How does it matter if its Matter?", true, "a10"], ["None of this matters", true, "a9"], ["IN THE END, IT DOESN'T MATTER -hevipelle", true, "a8"],
...
["GHOST SAYS HELLO -Boo-chan", true, "a15"], ["Can someone tell hevi to calm down? -Mee6", true, "a16"], ["Due to Matter messing with physics, a creature that was once a moose is now a human", true, "a17"], ["!hi", true, "a18"],
["Alright -Alright", true, "a19"], ["The English greeting is not present in Matter speak.", true, "a20"], ["To buy max or not to buy max, that is the question", true, "a21"], ["This Matter triggers me", true, "a22"],
...
["A new religion has been created, and it's spreading like wildfire. The believers of this religion worship the Heavenly Pelle, the goddess of Matter. They also believe that 10^308 is infinite.", true, "a27"], ["Someone has just touched a blob, and blown up. Was the blob Matter, or was the guy made of Explodium?", true, "a28"],
...
["Gee golly -Xandawesome", true, "a34"], ["Above us, there is nothing above, But the stars, above.", true, "a35"], ["If black lives matter, do white lives Matter?", true, "a36"], ["Somebody wasn't nice, he got an Matter-storm.", true, "a37"],
["You are living, you occupy space, you have a mass, you matter... unless you Matter.", true, "a38"], ["I clicked too fast... my PC is now dematerialised.", true, "a39"],
["If an alien lands on your front lawn and extends an appendage as a gesture of greeting, before you get friendly, toss it an eightball. If the appendage explodes, then the alien was probably made of Matter. If not, then you can proceed to take it to your leader. -Neil deGrasse Tyson", true, "a40"],
["There always must be equal matter than there is Matter, I guess your mom balances that a bit", true, "a41"], ["Nothing is created, nothing is destroyed.", true, "a42"], ["We dug a big hole to store this Matter... Adele's rolling in it.", true, "a43"],
["If everything is Matter, how can you see yourself?", true, "a44"], ["The stock markets have crashed due to Matter beings somehow knowing what they will be tomorrow.", true, "a45"], ["My dog ate too much Matter, now he is doing 'meow!'", true, "a46"], ["If you put infinity into your calculator it will result in 42!", true, "a47"],
["You have found the rarest Matter pepe, it's ultra rare!", true, "a48"], ["Can we get 1e169 likes on this video??? Smash that like button!!", true, "a49"],
["The smell of Matter has been revealed. It smells like kittens", true, "a50"], ["Just another Matter in the wall", true, "a51"], ["GET SNIPED, WEAKLING", true, "a52"], ["Thanks a lot -dankesehr", true, "a53"],
...
["A new chat server has been created for Matter people to spy on Matter people, and the world has fallen into chaos and discord", true, "a57"], ["A new study has come out linking the consumption of potatoes with increased risk of Matter implosion.  Scientists suggest eating more.", true, "a58"], ["I thought that I fixed that bug but apparently some update broke it again -hevipelle", true, "a59"],
...
["Matter guns don't kill Matter people, Matter people kill Matter people but does that mean that Matter toaster doesn't toast Matter toasts, Matter toast toasts Matter toasts?", true, "a63"],
["But to an Matter person, wouldn't they be matter and us Matter?", true, "a64"], ["And nothing Matters", true, "a65"],
["School starting up strikes fear in students universe-wide, as schools are no longer segregated between Matter and Matter. Annihilation is prominent.", true, "a66"],
["Why does no one talk about the 0th dimension?", true, "a67"], ["The fatter catter satter on the Matter.", true, "a68"], ["Who let the DOgs out?", true, "a69"], ["If you can't read this you disabled the news.", true, "a70"],
...
["Your Mother-in-Law keeps nagging you about all these Matter colliders.", true, "a76"], ["If matter exists, then does Matter not exist?", true, "a77"], ["Matter=Life. Not cobblestone, not dirt, nothing like that. Matter.", true, "a78"],
["Breaking News: Error Error Error", true, "a79"], ["How much wood could a woodchuck chuck if a woodchuck could chuck wood?", true, "a80"], ["Chaos isnt a pit, chaos is a matter", true, "a81"],
["That's because I'm a good game developer and pushed some code that totally works -hevipelle", true, "a82"], ["What's the antimatter with matter?", true, "a83"],
["Doesn't it annoy you when people don't finish their", true, "a84"], ["Don't quote me on this", true, "a85"], ["Matter is honest, matter makes up everything", true, "a86"],
["According to no known laws of aviation, there are multiple ways a bee should be able to be swallowed up by Matter", true, "a87"], ["You either die as matter or live long enough to be consumed by the Matter, and then die again", true, "a88"],
["If you gaze long enough into the Matter, the Matter gazes back into you", true, "a89"], ["Always gonna give you up. Always gonna let you down. - Rick Astley", true, "a90"],
["Matter Dimensions: the next update is always 5 hours away. Always.", true, "a91"], ["#DimensionLivesMatter", true, "a92"],
["Do Matter people with suicidal thoughts get depressants?", true, "a93"], ["To matter or to Matter, that is the question.", true, "a94"], ["Why is everything so Hevi?",  true, "a95"],
["It has been scientifically proven ages ago, that cats made of matter are assholes. We have good news, because cats made of Matter are still assholes",  true, "a96"],
["Nobody once told me the world wasn’t gonna roll me", true, "a97"], ["Matter is like internet. If you're reading this, you can't have enough of it.",  true, "a98"],
["Matter has made time travel possible and I'm here to make the past great again. - 2nd President of the World",  true, "a99"],
["Please insert Disc -1 to continue playing  Matter Dimensions ™.", true, "a100"], ["Lore - coming soon ™", true, "a101"],
["I was a part of Matter like you once. But then I got matter in my knee.", true, "a101"], ["Matter... Matter never changes... until you get to quantum physics of Matter, but we don't have enough tachyon particles for that.", true, "a102"],
["There is no war in Matter Dimensions. Here we are safe. Here we are free.", true, "a103"], ["Matter has solved global warming.  In unrelated news, the Earth no longer exists.",  true, "a104"],
["water, Earth, fire, air. Long ago, the four nations lived together in harmony. Then, everything changed when the Fire Nation attacked. Only the Avatar, the master of all 4 elements could bring balance to the world, but when the world needed him most, he accidentally touched some regular matter and exploded.",  true, "a105"],
["If you open an lootbox, are you selling random possessions for in-game currency?", true, "a106"], ["People are beginning to question Hevipelle's existence.",  true, "a107"], ["Matter Dimensions is proud to be sponsored by Lehmä! Now offering - grass eating lessons! Learn what grass is safe to eat and what grass isn't.",  true, "a108"],
...
["Only today you can call 1-800-MATTER and get a FREE Infinity Dimension! The package also comes with a COMPLETELY FREE SHIPPING and a FREE HIGH DEFINITION V!!! Only today for the low price of 42! Estimated delivery time - 5 hours.", true, "a124"],
["1e420 blaze it.", true, "a125"],
["This game doesn't have any bugs, you're just doing it wrong.", true, "a126"],
["Matter_Dimensions.mp1.79e308", true, "a127"],
...
["Someone once told me that Matter is gonna roll me. I ain't the sharpest atom in the shed. WELL, the tubes start coming and they don't stop coming...", true, "a132"],
...
["Matter people seem to be even more afraid of 13 then we are. They destroyed entire galaxies just to remove 13 from their percents.", "player.galaxies > 0 || player.infinitied > 0", "b8"],
...
["Matter ice cream stand has recently opened- they have octillions of flavors!", "player.totalmoney.e >= 27", "b13"],
["The Heavenly Pelle has generated too much Matter and needed to create another galaxy. This one can be seen in the southwestern sky.", "player.galaxies > 0 || player.infinitied > 0", "b21"],
...
["I've got 1.79e308 problems, but none of them Matters", "player.infinitied > 0 && !player.break", "b15"],
["Emoji Movie a huge hit", "player.spreadingCancer >= 5", "b18"],
...
["New strange material was been found. It seems to grow exponentially, but only helps with Matter production.", "player.replicanti.unl && player.replicanti.chance == 0.01", "b25"],
...
["New news company has become rivals with us. They are made entirely of Matter.", "player.newsArray.length >= 80", "n1"],
...
["I broke the 8th wall, there is only chaos, Slabdrill is ritually sacrificing Matter to the 9th dimension. This will be my last entry, may Hevipelle have mercy on our souls, we didn't listen, We should have listened.", 'player.newsArray.includes("b17")', "n6"],
...
["Where does Matter Nemo live? In a NNnNeMI-NNnNe.", "player.totalmoney.e >= 3e6", "c2"],  //might not be poss?
["Emoji Movie MMMCMXCIX is a major hit!", "player.spreadingCancer >= 3999", "c3"],
